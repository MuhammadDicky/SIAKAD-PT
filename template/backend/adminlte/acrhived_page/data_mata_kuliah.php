			...
			<div class="col-md-12 col-xs-12">
				<div class="box box-solid box-warning" id="box-content">
			        ...
			        <div class="box-body">
			        	...
			        	<div class="row">
			        		<div class="col-md-12">
				        		<div class="box box-warning box-daftar-mk" style="display: none;" data-search>
						            <div class="box-header with-border">
						            ...
						            <div class="box-body daftar-mp">
						            	<div class="row">
						            		<div class="col-lg-6 col-md-12 col-sm-12">
							        			<table class="table table-bordered table-striped table-hover tbl-data-mk1">
									                <thead>
									                <tr>
									                  ...
									                  <th style="width: 250px">Mata Kuliah</th>
							        		...
							        		<div class="col-lg-6 col-md-12 col-sm-12">
							        			<table class="table table-bordered table-striped table-hover tbl-data-mk2">
									                <thead>
									                <tr>
									                  <th class="text-center" style="width: 37px"><input type="checkbox" class="check-all-data check-all-mk" data-selected="check-mk" data-all-selected="check-all-mk" data-toggle=".edit-mk,.hapus"></th>
									                  <th class="text-center" style="width: 80px">Kode MK</th>
